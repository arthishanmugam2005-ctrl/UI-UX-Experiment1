...
Goal	Attractive interface	Easy and satisfying interaction
Includes	Colors, fonts, buttons, icons	Research, usability, navigation, testing
Success Measure	Looks professional	Users complete tasks easily

Case Study 1: Instagram:
UI: Clean layout, attractive icons, simple navigation, consistent color scheme. 
UX: Users can upload photos, view stories, and communicate quickly with minimal effort. 
Case Study 2: Amazon:
...
UX: Users can quickly find restaurants and place orders with minimal steps. 
...
Canva	Creating logos, social media graphics, presentations, and design assets.
Adobe XD	Designing interactive UI prototypes and user flows.
Sketch	Vector-based interface design for macOS.
InVision	Interactive prototyping and design collaboration.
Balsamiq	Low-fidelity wireframes for planning application layouts.
Tools Used in This Experiment
Figma: Designed desktop and mobile wireframes, layout grids, and interactive prototypes. 
Canva: Created the brand logo and visual assets. 
